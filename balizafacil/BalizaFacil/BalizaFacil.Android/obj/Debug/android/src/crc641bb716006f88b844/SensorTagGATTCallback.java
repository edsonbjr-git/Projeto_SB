package crc641bb716006f88b844;


public class SensorTagGATTCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BalizaFacil.Droid.Services.Bluetooth.SensorTagGATTCallback, BalizaFacil.Android", SensorTagGATTCallback.class, __md_methods);
	}


	public SensorTagGATTCallback ()
	{
		super ();
		if (getClass () == SensorTagGATTCallback.class)
			mono.android.TypeManager.Activate ("BalizaFacil.Droid.Services.Bluetooth.SensorTagGATTCallback, BalizaFacil.Android", "", this, new java.lang.Object[] {  });
	}
